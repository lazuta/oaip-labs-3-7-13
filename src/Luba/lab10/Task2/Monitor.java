...
public class Monitor extends Electronic {
    ...
    public Monitor(String name, double ves, double price, double count) {
        this.name = name;
        this.ves = ves;
        this.price = price;
        this.count = count;
    ...
    public Monitor(String name, double ves, double price, double count, String name1, double ves1, double price1, double count1) {
